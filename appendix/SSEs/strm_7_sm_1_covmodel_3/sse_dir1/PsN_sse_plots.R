...
#Created 2025-05-15 at 16:59

xpose.runno <- '7_sm_1_covmodel_3.mod'
toolname <- 'sse'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/workmtp/content/trialmp/Melanie/data_simulation/results/SSEs/strm_7_sm_1_covmodel_3/sse_dir1/'
results.directory <- '..'
...
raw.results.file <- 'raw_results_strm_7_sm_1_covmodel_3.csv'
...
samples   <-200
model.file.names <-  c('strm_7_sm_1_covmodel_3.mod')
