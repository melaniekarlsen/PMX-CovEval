...
#Created 2025-05-15 at 16:57

xpose.runno <- '7_sm_1_covmodel_21.mod'
toolname <- 'sse'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/workmtp/content/trialmp/Melanie/data_simulation/results/SSEs/strm_7_sm_1_covmodel_21/sse_dir1/'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- '/usr/lib/perl5/site_perl/5.26.1/PsN_5_3_0/R-scripts' # This is not used
tool.results.file <- 'sse_results.csv'
raw.results.file <- 'raw_results_strm_7_sm_1_covmodel_21.csv'
theta.labels <- c('POP_V2','POP_V3','POP_Q','POP_KA','POP_CL','POP_CLCLCR','POP_CLBR')
theta.fixed <- c(FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE)
omega.labels <- c('IIV_V2','IIV_CL_IIV_V2','IIV_CL','IIV_V3','IIV_KA')
...
samples   <-200
model.file.names <-  c('strm_7_sm_1_covmodel_21.mod')
model.rawres.names <- c('simulation')
model.subjects <- c(639)
model.estimated.params <- c(12)
